                                    ...
                                    <div class="col-md-offset-2 col-md-12 col-sm-10">
                                        <div class="single-contact-box">
                                            <div class="contact-form">
                                                @include('_messages')
                                                <form action="{{ url('admin/create-skill-store') }}" method="post" enctype="multipart/form-data" >
                                                    {{ csrf_field() }}
                                                    <div class="row">
                                                        <div class="col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <div class="input-group input-group-outline my-3">
                                                                    <input type="text" class="form-control" id="name" placeholder="Enter Your Skill" name="name">
                                                                </div>
                                                            </div><!--/.form-group-->
                                                        </div><!--/.col-->
                                                        <div class="col-sm-6 col-xs-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <button type="submit" class="btn bg-gradient-primary" name="update" id="update" role="button">Add Skill</button>
