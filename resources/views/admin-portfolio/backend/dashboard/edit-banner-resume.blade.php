          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Customized You index pages</h6>
              </div>
            </div>
                                    ...
                                    <div class="col-md-offset-2 col-md-12 col-sm-10">
                                        <div class="single-contact-box">
                                            <div class="contact-form">
                                                @include('_messages')
                                                <form action="{{ url('admin/preview-update-indexpages/' . $get_bannerdata->id) }}" method="post" enctype="multipart/form-data" >
                                                    {{ csrf_field() }}
                                                    @method('put')
                                                    <div class="row">
                                                        <div class="col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <div class="input-group input-group-outline my-3">
                                                                    <input type="text" class="form-control" id="name" placeholder="Name" name="name" value="{{ $get_bannerdata->name }}">
                                                                </div>
                                                            </div><!--/.form-group-->
                                                        </div><!--/.col-->
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                        ...
                                                                        <input type="file" class="form-control" id="subject" placeholder="Resume" name="resume">
                                                                    </div>
                                                                </div><!--/.form-group-->
                                                            </div><!--/.col-->
                                                        </div><!--/.row-->
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <div class="input-group input-group-outline my-3">
                                                                <input type="text" class="form-control" id="subject" placeholder="dev" name="dev" value="{{ $get_bannerdata->dev }}">
                                                                </div>
                                                            </div><!--/.form-group-->
                                                        </div><!--/.col-->
                                                    </div><!--/.row-->
                                            ...
                                            <div class="card-footer">
                                                <div class="row">
                                                    ...
                                                    <button type="submit" class="btn bg-gradient-primary" name="update" id="update" role="button">Save</button>
