                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href="{{ url('admin/edit-about') }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          edit
                        </a>
                      </td>
                      <td class="align-middle">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card my-4">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                  <h6 class="text-white text-capitalize ps-3"><a href="{{ url('admin/exprience') }}" class="text-white text-capitalize ps-3">About Experience</a></h6>
                </div>
              </div>
              <div class="card-body px-0 pb-2">
                <div class="table-responsive p-0">
